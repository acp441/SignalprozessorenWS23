...
#include "dec_by_2_FIR_PP_decomp.h"
...
short outData[NUM_POLY_BRANCHES];   // Data for the DAC
...
// Put your ADC DSP code here ...
    ...
    switch(poly_switch){
    case 0:
        outData[0] = FIR_filter_sc(H_filt_FIR_design_dec_2_1_lab2, b_FIR_dec_2_1_HP, N_DELAYS_FIR_DESIGN_DEC_BRANCH_2_1_LAB2, sData[0], 15);
        break;
    case 1:
        outData[1] = FIR_filter_sc(H_filt_FIR_design_dec_2_0_lab2, b_FIR_dec_2_0_HP, N_DELAYS_FIR_DESIGN_DEC_BRANCH_2_0_LAB2, sData[0], 15);
        break;
    default:
        break;
    }
...
__interrupt void dacInt (void)
{
    ...
    sData[0] = 0;
    for (idx=0; idx < NUM_POLY_BRANCHES; idx++){
        sData[0] += outData[idx];
    }
