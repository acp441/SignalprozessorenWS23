...
__interrupt void adcInt (void)
{
    ...
    *******************************************************************/
    ...
    input_sample = sData[0];
// Put your ADC DSP code here ...
    static int poly_switch = 0;

    switch(poly_switch){
    case 0:
        // Filter rechnen
        y_H_6_0 = FIR_filter_sc(H_filt_poly_60, b_poly_60, N_delays_poly_60, input_sample, 15);
        y_H_6_3 = FIR_filter_sc(H_filt_poly_63, b_poly_63, N_delays_poly_63, input_sample, 15);
        break;
    case 1:
        // Filter rechnen
        y_H_6_4 = FIR_filter_sc(H_filt_poly_64, b_poly_64, N_delays_poly_64, branch_1_buf, 15);
        y_H_6_1 = FIR_filter_sc(H_filt_poly_61, b_poly_61, N_delays_poly_61, input_sample, 15);

        // Sample zwischenspeichern
        branch_1_buf = input_sample;

        break;
    case 2:
        // Filter rechnen
        y_H_6_2 = FIR_filter_sc(H_filt_poly_62, b_poly_62, N_delays_poly_62, branch_2_buf, 15);
        y_H_6_5 = FIR_filter_sc(H_filt_poly_65, b_poly_65, N_delays_poly_65, branch_2_buf, 15);

        // Summen bilden
        dataOut[0] = y_H_6_0 + y_H_6_4 + y_H_6_2;
        dataOut[1] = y_H_6_3 + y_H_6_1 + y_H_6_5;

        poly_switch_dac = 0;

        // Sample zwischenspeichern
        branch_2_buf = input_sample;
...
__interrupt void dacInt (void)
{
    ...
    *******************************************************************/
    for (idx=0; idx<8; idx++)
	{
		PRU_addaRegs->dac[idx] = dataOut[poly_switch_dac];
	}
